...
architecture STRUCTURE of project_reti_logiche is
  ...
  signal \address_to_encode__0\ : STD_LOGIC_VECTOR ( 6 downto 0 );
  signal current_memory_address : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute SOFT_HLUTNM of \address_to_encode[6]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \current_memory_address[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \current_memory_address[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \current_memory_address[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \o_data[2]_i_1\ : label is "soft_lutpair0";
...
\FSM_sequential_current_state_reg[1]_i_5\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2 downto 0) => \address_to_encode__0\(6 downto 4),
      ...
      S(3) => '1',
      S(2) => \FSM_sequential_current_state[1]_i_6_n_0\,
      S(1) => \FSM_sequential_current_state[1]_i_7_n_0\,
      S(0) => \FSM_sequential_current_state[1]_i_8_n_0\
    );
\address_to_encode[6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"02"
    )
        port map (
      I0 => \address_to_encode[6]_i_2_n_0\,
      I1 => \current_state__0\(1),
      I2 => i_rst_IBUF,
      O => address_to_encode0
    );
\address_to_encode[6]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000008"
    )
        port map (
      ...
      I2 => \current_memory_address_reg_n_0_[2]\,
      I3 => \current_memory_address_reg_n_0_[0]\,
      I4 => \current_memory_address_reg_n_0_[1]\,
...
\address_to_encode_reg[6]\: unisim.vcomponents.FDRE
    generic map(
      ...
      CE => address_to_encode0,
      D => i_data_IBUF(6),
      Q => \address_to_encode__0\(6),
      R => '0'
    );
\current_memory_address[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"01320000"
    )
        port map (
      ...
      O => current_memory_address(0)
    );
\current_memory_address[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"01980000"
    )
        port map (
      ...
      I3 => \current_memory_address_reg_n_0_[3]\,
      I4 => \current_state__0\(0),
      O => current_memory_address(1)
    );
\current_memory_address[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"01E00000"
    )
        port map (
...
\current_memory_address[3]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \current_state__0\(0),
      O => current_memory_address(3)
    );
...
\o_data_reg[3]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '1',
      DI(3 downto 0) => \address_to_encode__0\(3 downto 0),
...
o_we_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \current_state__0\(0),
      I2 => \FSM_sequential_current_state[1]_i_4_n_0\,
      I3 => \current_memory_address_reg_n_0_[1]\,
      I4 => \current_memory_address_reg_n_0_[0]\,
      I5 => \current_memory_address_reg_n_0_[2]\,
      O => o_we_i_1_n_0
    );
